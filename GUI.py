...
# Creates the Text boxes on screen
...
# This function updates the value on the screen
...
# This function changes the units from Celsius to Fahrenheit and Vice-Versa
...
while True:
    event, values = window.read(timeout=0)  # Read events and values from the window
